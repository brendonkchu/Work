...
report_file_path = input("Enter the path to the report file (Example: C:\IBM\Alloy Campaign Report.xlsx): ")
...
appname = input("Enter the name of the application in IGI (Example: Alloy): ")
validation_report_path = input("Enter the path to save the validation report to (Example: C:\IBM\Alloy Campaign Report-Validation.xlsx): ")
