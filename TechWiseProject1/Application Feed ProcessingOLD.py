...
app_name = input("Please enter the name of the application in IGI: ")
...
source_file = input("Please enter the source Excel file location (e.g., \\\\192.168.100.186\\dropoff\\2023\\AppName\\FileName.xlsx): ")
destination_file = input("Please enter the destination CSV file location (e.g., C:\\IBM\\file2.csv): ")
